...
import { getAllFiles, deleteFile, shareFile } from "../../redux/actions/fileFolder.action";
...
const Files = (props) => {
  ...
  const deleteFile = () => {
    dispatch(deleteFile({id: contextlist[selectedContext]._id}))
  }

  const shareFile = () => {
    dispatch(shareFile({id: contextlist[selectedContext]._id}))
  }
          ...
          {selectedContext !== "" && (
            <View style={styles.inputview}>
              ...
              <View style={styles.actiongroup}>
                <TouchableOpacity style={styles.actionItem} onPress={deleteFile}>
